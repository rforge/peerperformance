####################################################################################
## Set of R functions for the optimal block length computation for the Sharpe ratio
####################################################################################

.sharpeBlockSize = function(x, y, control = list(), b.vec = c(1, 3, 6, 10), alpha = 0.05, M = 199, K = 500, b.av = 5, T.start = 50) {
